...
const client = new OpenAI({
  ...
  apiKey: "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",
  defaultQuery: { "use_cache": true },
  defaultHeaders: {
    "HTTP-Referer": "https://github.com/spheronFdn/yaml-gen",
...
export async function processRequest(userRequest) {
  try {
    ...
    if (match.templateId && match.confidence >= 0.8) {
      ...
      reasoning = "No high-confidence template match found. Using Jupyter notebook template with default values.";
    }
